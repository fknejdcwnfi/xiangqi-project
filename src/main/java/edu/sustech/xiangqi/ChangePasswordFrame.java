...
public class ChangePasswordFrame extends JFrame {
    ...
    public ChangePasswordFrame() {
        ...
        changePasswordLabel.setFont(new Font("华文行楷", Font.BOLD, 24));
        ...
        theUserName.setFont(new Font("华文行楷", Font.PLAIN, 14));
        ...
        newPasswordText.setFont(new Font("华文行楷", Font.PLAIN, 14));
        ...
        changePasswordButton.setFont(new Font("华文行楷", Font.BOLD, 16));
        ...
        returnTotheGame.setFont(new Font("华文行楷", Font.BOLD, 16));
        ...
        susTochangePassword.setFont(new Font("华文行楷", Font.PLAIN, 12));
